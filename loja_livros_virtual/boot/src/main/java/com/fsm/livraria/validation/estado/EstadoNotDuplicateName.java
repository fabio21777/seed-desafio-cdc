...
@Repeatable(EstadoNotDuplicateName.List.class)
@Documented
@Constraint(validatedBy = {})
public @interface EstadoNotDuplicateName {

    String MESSAGE = "micronaut.EstadoNotDuplicateName.message";
