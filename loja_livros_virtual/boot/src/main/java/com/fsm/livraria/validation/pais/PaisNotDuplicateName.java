...
@Repeatable(PaisNotDuplicateName.List.class)
@Documented
@Constraint(validatedBy = {})
public @interface PaisNotDuplicateName {

    String MESSAGE = "micronaut.PaisNotDuplicateName.message";
